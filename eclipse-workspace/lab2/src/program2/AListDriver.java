...
public class AListDriver {
    ...
    public static void main(String[] args) {
        ...
        // move current position to 1, and insert an element
        list.moveToPos(1);
        list.insert(5);
        list.show();
        ...
        // move to end, and check if the current position is at end.
        list.moveToEnd();
        System.out.println(
        "last: " + list.getValue());
       
        System.out.println("is the element at end?: " +
           list.isAtEnd());
       
        // show previous and next elements of an element
        list.prev(); list.prev();
        System.out.println(list.getValue() + ", "
                + "position: " + list.currPos());
        list.next();
        System.out.println(list.getValue() + ", "
                + "position: " + list.currPos());
        list.show();
